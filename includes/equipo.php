		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-3 d-inline-flex justify-content-center">
					<div class="team-member">
						<div class="team-photo">
							<img src="images/team-b-sq.png" alt="team">
						...
						<div id="team-profile-3" class="team-profile mfp-hide">
							...
							<div class="container-fluid">
								<div class="row no-mg">
									<div class="col-md-6">
										<div class="team-profile-photo">
											<img src="images/team-c-lg.png" alt="team" />
										</div>
									</div><!-- .col  -->
				...
				<div class="col-md-6 col-lg-3 d-inline-flex justify-content-center">
					<div class="team-member">
						<div class="team-photo">
							<img src="images/team-d-sq.png" alt="team">
					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-3 d-inline-flex justify-content-center">
							<div class="team-member">
								<div class="team-photo">
									<img src="images/team-g-sq.png" alt="team">
						...
						<div class="col-md-6 col-lg-3 d-inline-flex justify-content-center">
							<div class="team-member">
								<div class="team-photo">
									<img src="images/team-h-sq.png" alt="team">
									<a href="#team-profile-8" class="expand-trigger content-popup"></a>
								</div>
								<div class="team-info" >
									<h5 class="team-name">Mario <br>Zapata</h5>
									<span class="team-title">Vinculación <br>con el Medio</span>
									<ul class="team-social">
										<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
										<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
                                        <li><a href=""><em class="fab fa-twitter"></em></a></li>
								...
								<div id="team-profile-8" class="team-profile mfp-hide">
									...
									<div class="container-fluid">
										<div class="row no-mg">
											...
											<div class="col-md-6">
												<div class="team-profile-info">
													<h3 class="name">Mario Zapata</h3>
													<p class="sub-title">Vinculación con el Medio</p>
													<ul class="tpi-social">
														<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
														<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
														<li><a href=""><em class="fab fa-twitter"></em></a></li>
				...
				<div class="col-lg-9 col-md-12">
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 d-inline-flex justify-content-center">
							<div class="team-member">
								<div class="team-photo">
									<img src="images/team-i-sq.png" alt="team">
						...
						<div class="col-lg-4 col-md-6 d-inline-flex justify-content-center">
							<div class="team-member">
								<div class="team-photo">
									<img src="images/team-j-sq.png" alt="team">
									<a href="#team-profile-10" class="expand-trigger content-popup"></a>
								</div>
								<div class="team-info">
									<h5 class="team-name">Josefa <br>Fuentes</h5>
									<span class="team-title">Ex Community Manager</span>
									<ul class="team-social">
										<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
										<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
										<li><a href=""><em class="fab fa-twitter"></em></a></li>
								...
								<div id="team-profile-10" class="team-profile mfp-hide">
									...
									<div class="container-fluid">
										<div class="row no-mg">
											...
											<div class="col-md-6">
												<div class="team-profile-info">
													<h3 class="name">Josefa Fuentes</h3>
													<p class="sub-title">Ex Community Manager (2019)</p>
													<ul class="tpi-social">
														<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
														<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
														<li><a href=""><em class="fab fa-twitter"></em></a></li>
						...
						<div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0 d-inline-flex justify-content-center" >
							<div class="team-member">
								<div class="team-photo">
									<img src="images/team-k-sq.png" alt="team">
									<a href="#team-profile-11" class="expand-trigger content-popup"></a>
								</div>
								<div class="team-info" >
									<h5 class="team-name">Mauricio <br>Gutíerrez</h5>
									<span class="team-title">Ex Community Manager</span>
									<ul class="team-social">
										<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
										<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
								...
								<div id="team-profile-11" class="team-profile mfp-hide">
									...
									<div class="container-fluid">
										<div class="row no-mg">
											...
											<div class="col-md-6">
												<div class="team-profile-info">
													<h3 class="name">Mauricio Gutíerrez</h3>
													<p class="sub-title">Ex Community Manager (2019)</p>
													<ul class="tpi-social">
														<li><a href=""><em class="fab fa-facebook-f"></em></a></li>
														<li><a href=""><em class="fab fa-linkedin-in"></em></a></li>
